...
description: This how-to explains the steps to connect to a tenant database in SPA HANA, express edition, created in the Google Cloud Platform created from the Launcher
primary_tag:
